 ...
 */
@ServiceProvider(service = RtcMultiViewGroupFactory.class, path = "Rtc/Modules/PlansModule/PlanMultiViewDescriptions", position = 100)
public class RtcOverViewPageEditorMVGroupFactory implements RtcMultiViewGroupFactory {

    @Override
    public KinoMultiViewGroup getGroup(RtcPlan plan) {
        return new RtcOverViewPageEditorMVGroup(plan);
    }
