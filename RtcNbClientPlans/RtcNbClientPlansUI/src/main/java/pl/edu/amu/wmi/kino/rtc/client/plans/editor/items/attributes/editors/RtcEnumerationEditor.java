...
public class RtcEnumerationEditor extends PropertyEditorSupport
    ...
    private static class Inplace implements InplaceEditor, ActionListener {
        ...
        public Inplace(List<RtcLiteral> possibleValues, final Lookup context) {
            ...
            for (RtcLiteral l : possibleValues) {
                JMenuItem item = new RtcMenuItem(l.getName(), l);
                if (l.getIcon() != null) {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() instanceof RtcMenuItem) {
                ...
                editor.setValue(menuItem.getLiteral());
                setValue(menuItem.getLiteral());
            }
        }
        ...
        public void setValue(Object object) {
            RtcLiteral l = (RtcLiteral) object;
            literal = l;
        ...
        public void connect(PropertyEditor propertyEditor, PropertyEnv env) {
            ...
            this.env = env;
            this.literal = (RtcLiteral) editor.getValue();
            reset();
        ...
        private class RtcMenuItem extends JMenuItem {
			...
			private static final long serialVersionUID = -5461270208332913984L;
			private RtcLiteral literal;

            public RtcMenuItem(String text, Icon icon, RtcLiteral literal) {
                super(text, icon);
                this.literal = literal;
            }

            public RtcMenuItem(String text, RtcLiteral literal) {
                super(text);
                this.literal = literal;
            }

            public RtcLiteral getLiteral() {
                return literal;
            }
        }
