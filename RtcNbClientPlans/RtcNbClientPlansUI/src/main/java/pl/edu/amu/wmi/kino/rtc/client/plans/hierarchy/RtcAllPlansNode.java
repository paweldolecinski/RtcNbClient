 ...
 */
public class RtcAllPlansNode extends AbstractNode {

    private Action[] actions;

    public RtcAllPlansNode(InstanceContent ic) {
        super(Children.LEAF, new AbstractLookup(ic));
        setChildren(Children.create(new RtcAllPlansNodeChildFactory(
    ...
    public Action[] getActions(boolean bln) {
        if (actions == null) {
            List<? extends Action> list = Utilities.actionsForPath("Rtc/Modules/PlansModule/AllPlansNodeActions");
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx(RtcAllPlansNode.class);
    }
}
