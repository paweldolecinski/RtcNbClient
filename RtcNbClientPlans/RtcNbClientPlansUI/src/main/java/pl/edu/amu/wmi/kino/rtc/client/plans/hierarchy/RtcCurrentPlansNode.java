 ...
 */
public class RtcCurrentPlansNode extends AbstractNode {

    private Action[] actions;

    public RtcCurrentPlansNode(InstanceContent ic) {
        super(Children.LEAF, new AbstractLookup(ic));
        setChildren(Children.create(new RtcCurrentPlansNodeChildFactory(
                getLookup().lookup(RtcPlansManager.class),
                getLookup().lookup(ActiveProjectArea.class),
                getLookup().lookup(ProcessManager.class)), true));
    ...
    public Action[] getActions(boolean bln) {
        if (actions == null) {
            List<? extends Action> list = Utilities.actionsForPath("Rtc/Modules/PlansModule/CurrentPlansNodeActions");
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx(RtcCurrentPlansNode.class);
    }
}
