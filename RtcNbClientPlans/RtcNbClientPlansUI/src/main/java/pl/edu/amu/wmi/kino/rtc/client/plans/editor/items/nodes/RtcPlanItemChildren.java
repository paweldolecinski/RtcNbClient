 ...
 */
public class RtcPlanItemChildren extends ChildFactory<RtcPlanItem> {

    private RtcPlanItem planItem;
    private RtcPlan plan;

    public RtcPlanItemChildren(RtcPlanItem planItem, RtcPlan plan) {
    ...
    protected boolean createKeys(List<RtcPlanItem> toPopulate) {
        toPopulate.addAll(Arrays.asList(planItem.getChildItems()));
        return true;
    }
