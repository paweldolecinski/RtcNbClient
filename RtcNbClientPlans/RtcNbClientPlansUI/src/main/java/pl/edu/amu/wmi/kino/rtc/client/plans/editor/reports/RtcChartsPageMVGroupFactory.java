 ...
 */
@ServiceProvider(service = RtcMultiViewGroupFactory.class, path = "Rtc/Modules/PlansModule/PlanMultiViewDescriptions", position = 300)
public class RtcChartsPageMVGroupFactory implements RtcMultiViewGroupFactory {

    @Override
    public KinoMultiViewGroup getGroup(RtcPlan plan) {
        return new RtcChartsPageMVGroup(plan);
    }
}
