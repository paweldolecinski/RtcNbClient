 ...
 */
public class RtcNotChangedFilterTest {

    private static RtcNotChangedFilter filter;
    private static RtcPlanItem[] planItems;

    /**
     *
     */
    public RtcNotChangedFilterTest() {
    }
    ...
    public static void setUpClass() throws Exception {
        filter = new RtcNotChangedFilter();
    ...
    private static class RtcPlanItemMockup extends RtcPlanWorkItem {
        ...
        public RtcPlanItemMockup(boolean dirty) {
            this.dirty = dirty;
        }
