 ...
 */
public class RtcWorkBreakdownFactory implements RtcPlanItemViewModeFactory {
    ...
    public RtcPlanItemViewMode createViewMode(RtcPlanItemViewModeManager manager) {
        return new RtcWorkBreakdown(manager);
    }
}
 ...
 */
class RtcWorkBreakdown extends RtcPlanItemViewModeImpl {

    private final String id = "com.ibm.team.apt.viewmodes.internal.workBreakdown";    // NON-I18L
    private RtcPlanItemViewModeManagerImpl manager;

    RtcWorkBreakdown(RtcPlanItemViewModeManager manager) {
        this.manager = (RtcPlanItemViewModeManagerImpl) manager;
        this.name = NbBundle.getMessage(RtcWorkBreakdown.class, "planmode.name.workBreakdown");
    }
    ...
    public boolean equals(Object obj) {
        ...
        final RtcWorkBreakdown other = (RtcWorkBreakdown) obj;
