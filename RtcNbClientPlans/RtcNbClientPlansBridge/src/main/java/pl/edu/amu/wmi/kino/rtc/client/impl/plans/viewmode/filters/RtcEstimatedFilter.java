 ...
 */
public class RtcEstimatedFilter extends RtcPlanItemFilter {

    private static final String attibuteId = "com.ibm.team.apt.attribute.planitem.estimate";
    ...
    public String getDisplayName() {
        return NbBundle.getMessage(RtcEstimatedFilter.class, "filter.name.estimated");
    }
    ...
    public boolean isFiltered(RtcPlanItem planItem) {
        if (planItem instanceof RtcPlanWorkItem) {
            ...
            if (planItem.getPlanAttributeValue(planItemAttribute) == null) {
                return true;
            }
        }
        return false;
