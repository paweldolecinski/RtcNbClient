...
class RtcFavoritesFolderNode extends AbstractNode {
    //potem mozna to zastapic przez implementacje Children.Keys ale to bedzie wiecej zabawy
    ...
    public RtcFavoritesFolderNode(InstanceContent ic) {
        ...
        setIconBaseWithExtension("pl/edu/amu/wmi/kino/rtc/client/favorites/nodes/folder.gif");
    }
