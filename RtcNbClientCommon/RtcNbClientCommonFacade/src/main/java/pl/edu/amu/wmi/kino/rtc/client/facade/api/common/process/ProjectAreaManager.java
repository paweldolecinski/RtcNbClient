 ...
 */
public interface ProjectAreaManager extends EventSource<ProjectAreasManagerEvent> {
    public abstract ProjectArea[] getProjectAreas();
    public abstract ProjectArea findProjectArea(String id);
