 ...
 */
public interface RtcApprovalDescriptor extends RtcApproval {

    public void setDueDate(Timestamp time);

    public RtcApproval createApproval(Contributor rtcContributor);
