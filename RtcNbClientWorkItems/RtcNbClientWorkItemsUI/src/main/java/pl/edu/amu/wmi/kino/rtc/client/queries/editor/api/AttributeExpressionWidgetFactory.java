 ...
 */
public interface AttributeExpressionWidgetFactory {

    Widget[] createAttributeExpressionWidget(RtcEditableAttributeExpression expression,RtcQuery query, Scene scene);
}
