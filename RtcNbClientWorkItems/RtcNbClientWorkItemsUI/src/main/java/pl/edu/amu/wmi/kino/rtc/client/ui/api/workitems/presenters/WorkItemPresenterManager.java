 ...
 */
public interface WorkItemPresenterManager {
     ...
     * @return
     */
    public abstract WorkItemPresenter createPresenter(
            RtcWorkItem wi, RtcWorkItemViewTarget target);
    /**
     * 
     * @param wi
     * @param target
     * @return
     */
    public abstract Node createNodePresenter(
            RtcWorkItem wi, RtcWorkItemViewTarget target);
