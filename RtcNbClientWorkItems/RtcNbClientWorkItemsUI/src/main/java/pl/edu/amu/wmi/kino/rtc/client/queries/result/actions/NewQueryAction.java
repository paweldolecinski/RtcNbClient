 ...
 * @author Szymon Sadło
 */
public class NewQueryAction extends CallableSystemAction implements LookupListener, Runnable {

    private Result<RtcQuery> result;
    private RtcEditableQuery newQuery;
    private RtcEditableQueriesSet queriesSet;
    ...
    public void performAction() {
        ...
        queriesSet = query.getQueriesManager().getPersonalQueriesSet();
        newQuery = queriesSet.createEditableQuery();
        EventQueue.invokeLater(this);
    }

    @Override
    public void run() {
        QueryEditorTopComponent tc = QueryEditorTopComponent.findInstanceFor(newQuery, queriesSet);
        tc.open();
        tc.requestActive();
    }
    ...
    protected String iconResource() {
        return "pl/edu/amu/wmi/kino/rtc/client/queries/result/actions/new_query.gif";
    }

    @Override
    public String getName() {
        return NbBundle.getMessage(NewQueryAction.class, "NewQueryAction.name");
    }
