...
public class AttributeWidget extends Widget {
    ...
    public AttributeWidget(Scene scene, RtcEditableAttributeExpression expression) {
        super(scene);
        addChild(new LabelWidget(scene, expression.getQueryAttribute().getDisplayName()));
    }
}
