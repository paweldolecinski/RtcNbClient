 ...
 * @author michu
 */
public class RtcCategoryEditor extends PropertyEditorSupport
    ...
    public RtcCategoryEditor(Lookup context) {
    ...
    public String getAsText() {
        if (getValue() instanceof RtcCategory) {
            return ((RtcCategory) getValue()).getName();
        }
        return "";
    }
    ...
    private static class Inplace implements InplaceEditor {
        ...
        public Inplace(List<RtcCategory> possibleValues, final Lookup context) {
            ...
            combobox.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    //ICategoryHandle o = (ICategoryHandle) ((RtcCategoryImpl) ((JComboBox)e.getSource()).getSelectedItem()).getCategory().getItemHandle();
                    context.lookup(RtcWorkItemAttribute.class).setValue((RtcCategory) ((JComboBox)e.getSource()).getSelectedItem());
                }
            });
        }
...
//    }
//
//    public static class ToStringProviderImpl implements ToStringProvider<ICategoryHandle> {
//
//        @Override
//        public String toString(ICategoryHandle value) {
//            if (value.hasFullState()) {
//                return ((ICategory) value.getFullState()).getName();
//            }
