 ...
 */
@Deprecated
public class RtcTimestampValueChecker implements RtcWorkItemAttributeValueChecker<Timestamp>{

    public RtcTimestampValueChecker() {
    }

    @Override
    public boolean isvalueProper(Timestamp value) {
        return true;
    }
