 ...
 */
public class RtcWorkItemTagsAttribute extends RtcWorkItemIAttribute<List<String>> {

    public RtcWorkItemTagsAttribute(Class valueType, ToStringProvider<List<String>> stringProvider, IAttribute iAttribute, RtcWorkItem wi, Object... aditionalContextContent) {
    ...
    protected void getValueInvoked() {
        ...
        if (!(value != null && value instanceof List)) {
            ...
            SeparatedStringList v = (SeparatedStringList) wi.getValue(this);
    ...
    @Override
    protected void setValueInvoked(List<String> value) {
...
//            getLookup().lookup(RtcWorkItem.class).setValue(this, v);
    ...
    public static class ToStringProviderImpl implements ToStringProvider<List<String>> {
    ...
    public class WorkingCopyTagsListener extends WorkingCopyListener {
