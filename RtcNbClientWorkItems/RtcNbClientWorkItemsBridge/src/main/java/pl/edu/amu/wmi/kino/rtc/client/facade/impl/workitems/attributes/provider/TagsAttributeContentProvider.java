...
public class TagsAttributeContentProvider implements AttributeContentProvider {
			...
			ic.add(new TagsMarker() {
				...
				public RtcWorkItemAttribute<String> getAttribute() {
					...
					try {
						...
						// shouldn't happen
						RtcLogger.getLogger(TagsAttributeContentProvider.class)
